...
g_skos.bind('geof', rdflib.Namespace("https://linked.data.gov.au/def/geofeatures/"))
...
g_skos.remove((
    rdflib.URIRef("https://linked.data.gov.au/def/geofeatures"),
...
g_skos.add((
    ...
    rdflib.Literal(
        ...
        "(https://linked.data.gov.au/def/geofeatures)", lang='en')
))
